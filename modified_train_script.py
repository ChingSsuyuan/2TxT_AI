...
def main():
    ...
    parser.add_argument('--val_db_path', default='', help='path to validation database (optional)')
    parser.add_argument('--val_table_name', default='', help='validation table name (optional)')
